...
(
	...
	weight FLOAT,
	systolicBloodPressure INT(3),
	diastolicBloodPressure INT(3),
...
(
	...
	distance DOUBLE,
	min_seden INT(5),
	min_light_active INT(5),
	min_fair_active INT(5),
	min_very_active INT(5),
	activity_cal INT(5),
...
(
	...
	hr_average INT(5),
	hr_highest INT(5),
	min_uv_exposure INT(5),
	activity_hours INT(5),
	workout_date DATE NOT NULL,
	id VARCHAR(20) NOT NULL,
	PRIMARY KEY (id)
)  ENGINE=MyISAM;