...
%>
	...
	<table>
		...
		<!-- Add code here with link text "Return to message inbox" -->
		<tr>
			<td colspan="2"><a href ="/iTrust/auth/hcp-patient/messageInbox.jsp" style="font-size: 18px;">Return to message inbox</a></td> 
		</tr>
	</table>
